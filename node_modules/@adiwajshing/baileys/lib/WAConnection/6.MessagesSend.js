    ...
    async prepareMessageMedia(media, mediaType, options = {}) {
        ...
        const message = {
            [mediaType]: Constants_1.MessageTypeProto[mediaType].fromObject({
                ...
                fileLength: options.fileLength || fileLength,
                ...
                streamingSidecar: mediaType === Constants_1.MessageType.audio || mediaType === Constants_1.MessageType.video ? Utils_1.randomBytes(30) : undefined
            })
        };
